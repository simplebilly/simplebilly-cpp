...
void RfqStatusUpdate::validate()
{
    // TODO: implement validation
}

web::json::value RfqStatusUpdate::toJson() const
{
...
bool RfqStatusUpdate::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void RfqStatusUpdate::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RfqStatusUpdate::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t RfqStatusUpdate::getStatus() const
{
    return m_Status;
}


void RfqStatusUpdate::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool RfqStatusUpdate::statusIsSet() const
{
    return m_StatusIsSet;
}

void RfqStatusUpdate::unsetStatus()
{
    m_StatusIsSet = false;
}
