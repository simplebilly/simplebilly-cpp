...
void ReturnOrderStatusUpdate::validate()
{
    // TODO: implement validation
}

web::json::value ReturnOrderStatusUpdate::toJson() const
{
...
bool ReturnOrderStatusUpdate::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ReturnOrderStatusUpdate::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ReturnOrderStatusUpdate::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ReturnOrderStatusUpdate::getStatus() const
{
    return m_Status;
}


void ReturnOrderStatusUpdate::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool ReturnOrderStatusUpdate::statusIsSet() const
{
    return m_StatusIsSet;
}

void ReturnOrderStatusUpdate::unsetStatus()
{
    m_StatusIsSet = false;
}
