...
void ProductionOrderStatusUpdate::validate()
{
    // TODO: implement validation
}

web::json::value ProductionOrderStatusUpdate::toJson() const
{
...
bool ProductionOrderStatusUpdate::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ProductionOrderStatusUpdate::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ProductionOrderStatusUpdate::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ProductionOrderStatusUpdate::getStatus() const
{
    return m_Status;
}


void ProductionOrderStatusUpdate::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool ProductionOrderStatusUpdate::statusIsSet() const
{
    return m_StatusIsSet;
}

void ProductionOrderStatusUpdate::unsetStatus()
{
    m_StatusIsSet = false;
}
