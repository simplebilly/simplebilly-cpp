...
ConfigFieldKind_oneOf::ConfigFieldKind_oneOf()
{
    m_TypeIsSet = false;
}
...
void ConfigFieldKind_oneOf::validate()
{
    // TODO: implement validation
}

web::json::value ConfigFieldKind_oneOf::toJson() const
{
...
bool ConfigFieldKind_oneOf::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ConfigFieldKind_oneOf::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ConfigFieldKind_oneOf::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
ConfigFieldKind_oneOf::TypeEnum ConfigFieldKind_oneOf::toTypeEnum(const utility::string_t& value) const
{
...
const utility::string_t ConfigFieldKind_oneOf::fromTypeEnum(const TypeEnum value) const
{
    switch(value)
    {
...
ConfigFieldKind_oneOf::TypeEnum ConfigFieldKind_oneOf::getType() const
{
    return m_Type;
}


void ConfigFieldKind_oneOf::setType(const TypeEnum value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool ConfigFieldKind_oneOf::typeIsSet() const
{
    return m_TypeIsSet;
}

void ConfigFieldKind_oneOf::unsetType()
{
    m_TypeIsSet = false;
}
