...
ApiResponse_Vec_Team::ApiResponse_Vec_Team()
{
    m_DataIsSet = false;
    m_Success = false;
...
void ApiResponse_Vec_Team::validate()
{
    // TODO: implement validation
}

web::json::value ApiResponse_Vec_Team::toJson() const
{
...
bool ApiResponse_Vec_Team::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<ApiResponse_Team_data>> refVal_setData;
...
void ApiResponse_Vec_Team::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ApiResponse_Vec_Team::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<ApiResponse_Team_data>> ApiResponse_Vec_Team::getData() const
{
    return m_Data;
}


void ApiResponse_Vec_Team::setData(const std::vector<std::shared_ptr<ApiResponse_Team_data>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool ApiResponse_Vec_Team::dataIsSet() const
{
    return m_DataIsSet;
}

void ApiResponse_Vec_Team::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t ApiResponse_Vec_Team::getError() const
{
    return m_Error.get();
}


void ApiResponse_Vec_Team::setError(const utility::string_t& value)
{
    m_Error = value;
}

bool ApiResponse_Vec_Team::errorIsSet() const
{
    return m_Error.has_value();
}

void ApiResponse_Vec_Team::unsetError()
{
    m_Error.reset();
}
utility::string_t ApiResponse_Vec_Team::getMessage() const
{
    return m_Message.get();
}


void ApiResponse_Vec_Team::setMessage(const utility::string_t& value)
{
    m_Message = value;
}

bool ApiResponse_Vec_Team::messageIsSet() const
{
    return m_Message.has_value();
}

void ApiResponse_Vec_Team::unsetMessage()
{
    m_Message.reset();
}
bool ApiResponse_Vec_Team::isSuccess() const
{
    return m_Success;
}

void ApiResponse_Vec_Team::setSuccess(bool value)
{
    m_Success = value;
    m_SuccessIsSet = true;
}

bool ApiResponse_Vec_Team::successIsSet() const
{
    return m_SuccessIsSet;
}

void ApiResponse_Vec_Team::unsetSuccess()
{
    m_SuccessIsSet = false;
}
