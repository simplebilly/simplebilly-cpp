...
OffenlegungItem::OffenlegungItem()
{
    m_Exists = false;
    m_ExistsIsSet = false;
...
void OffenlegungItem::validate()
{
    // TODO: implement validation
}

web::json::value OffenlegungItem::toJson() const
{
...
bool OffenlegungItem::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void OffenlegungItem::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool OffenlegungItem::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool OffenlegungItem::isExists() const
{
    return m_Exists;
}

void OffenlegungItem::setExists(bool value)
{
    m_Exists = value;
    m_ExistsIsSet = true;
}

bool OffenlegungItem::existsIsSet() const
{
    return m_ExistsIsSet;
}

void OffenlegungItem::unsetExists()
{
    m_ExistsIsSet = false;
}
utility::string_t OffenlegungItem::getName() const
{
    return m_Name;
}


void OffenlegungItem::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool OffenlegungItem::nameIsSet() const
{
    return m_NameIsSet;
}

void OffenlegungItem::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t OffenlegungItem::getSource() const
{
    return m_Source;
}


void OffenlegungItem::setSource(const utility::string_t& value)
{
    m_Source = value;
    m_SourceIsSet = true;
}

bool OffenlegungItem::sourceIsSet() const
{
    return m_SourceIsSet;
}

void OffenlegungItem::unsetSource()
{
    m_SourceIsSet = false;
}
