...
void AppointmentStatusUpdate::validate()
{
    // TODO: implement validation
}

web::json::value AppointmentStatusUpdate::toJson() const
{
...
bool AppointmentStatusUpdate::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AppointmentStatusUpdate::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AppointmentStatusUpdate::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t AppointmentStatusUpdate::getStatus() const
{
    return m_Status;
}


void AppointmentStatusUpdate::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool AppointmentStatusUpdate::statusIsSet() const
{
    return m_StatusIsSet;
}

void AppointmentStatusUpdate::unsetStatus()
{
    m_StatusIsSet = false;
}
