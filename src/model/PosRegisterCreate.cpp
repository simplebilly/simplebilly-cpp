...
void PosRegisterCreate::validate()
{
    // TODO: implement validation
}

web::json::value PosRegisterCreate::toJson() const
{
...
bool PosRegisterCreate::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PosRegisterCreate::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PosRegisterCreate::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t PosRegisterCreate::getName() const
{
    return m_Name;
}


void PosRegisterCreate::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool PosRegisterCreate::nameIsSet() const
{
    return m_NameIsSet;
}

void PosRegisterCreate::unsetName()
{
    m_NameIsSet = false;
}
std::shared_ptr<PosRegisterStatus> PosRegisterCreate::getStatus() const
{
    return m_Status;
}


void PosRegisterCreate::setStatus(const std::shared_ptr<PosRegisterStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool PosRegisterCreate::statusIsSet() const
{
    return m_StatusIsSet;
}

void PosRegisterCreate::unsetStatus()
{
    m_StatusIsSet = false;
}
