...
void RemoveUserRequest::validate()
{
    // TODO: implement validation
}

web::json::value RemoveUserRequest::toJson() const
{
...
bool RemoveUserRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void RemoveUserRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RemoveUserRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t RemoveUserRequest::getEmail() const
{
    return m_Email;
}


void RemoveUserRequest::setEmail(const utility::string_t& value)
{
    m_Email = value;
    m_EmailIsSet = true;
}

bool RemoveUserRequest::emailIsSet() const
{
    return m_EmailIsSet;
}

void RemoveUserRequest::unsetEmail()
{
    m_EmailIsSet = false;
}
