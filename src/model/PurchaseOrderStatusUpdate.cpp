...
void PurchaseOrderStatusUpdate::validate()
{
    // TODO: implement validation
}

web::json::value PurchaseOrderStatusUpdate::toJson() const
{
...
bool PurchaseOrderStatusUpdate::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PurchaseOrderStatusUpdate::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PurchaseOrderStatusUpdate::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t PurchaseOrderStatusUpdate::getStatus() const
{
    return m_Status;
}


void PurchaseOrderStatusUpdate::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool PurchaseOrderStatusUpdate::statusIsSet() const
{
    return m_StatusIsSet;
}

void PurchaseOrderStatusUpdate::unsetStatus()
{
    m_StatusIsSet = false;
}
