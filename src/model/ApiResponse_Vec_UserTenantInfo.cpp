...
ApiResponse_Vec_UserTenantInfo::ApiResponse_Vec_UserTenantInfo()
{
    m_DataIsSet = false;
    m_Success = false;
...
void ApiResponse_Vec_UserTenantInfo::validate()
{
    // TODO: implement validation
}

web::json::value ApiResponse_Vec_UserTenantInfo::toJson() const
{
...
bool ApiResponse_Vec_UserTenantInfo::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<ApiResponse_Vec_UserTenantInfo_data_inner>> refVal_setData;
...
void ApiResponse_Vec_UserTenantInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ApiResponse_Vec_UserTenantInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<ApiResponse_Vec_UserTenantInfo_data_inner>> ApiResponse_Vec_UserTenantInfo::getData() const
{
    return m_Data;
}


void ApiResponse_Vec_UserTenantInfo::setData(const std::vector<std::shared_ptr<ApiResponse_Vec_UserTenantInfo_data_inner>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool ApiResponse_Vec_UserTenantInfo::dataIsSet() const
{
    return m_DataIsSet;
}

void ApiResponse_Vec_UserTenantInfo::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t ApiResponse_Vec_UserTenantInfo::getError() const
{
    return m_Error.get();
}


void ApiResponse_Vec_UserTenantInfo::setError(const utility::string_t& value)
{
    m_Error = value;
}

bool ApiResponse_Vec_UserTenantInfo::errorIsSet() const
{
    return m_Error.has_value();
}

void ApiResponse_Vec_UserTenantInfo::unsetError()
{
    m_Error.reset();
}
utility::string_t ApiResponse_Vec_UserTenantInfo::getMessage() const
{
    return m_Message.get();
}


void ApiResponse_Vec_UserTenantInfo::setMessage(const utility::string_t& value)
{
    m_Message = value;
}

bool ApiResponse_Vec_UserTenantInfo::messageIsSet() const
{
    return m_Message.has_value();
}

void ApiResponse_Vec_UserTenantInfo::unsetMessage()
{
    m_Message.reset();
}
bool ApiResponse_Vec_UserTenantInfo::isSuccess() const
{
    return m_Success;
}

void ApiResponse_Vec_UserTenantInfo::setSuccess(bool value)
{
    m_Success = value;
    m_SuccessIsSet = true;
}

bool ApiResponse_Vec_UserTenantInfo::successIsSet() const
{
    return m_SuccessIsSet;
}

void ApiResponse_Vec_UserTenantInfo::unsetSuccess()
{
    m_SuccessIsSet = false;
}
