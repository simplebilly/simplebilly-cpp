...
ApiResponse_UserProfile::ApiResponse_UserProfile()
{
    m_DataIsSet = false;
    m_Success = false;
...
void ApiResponse_UserProfile::validate()
{
    // TODO: implement validation
}

web::json::value ApiResponse_UserProfile::toJson() const
{
...
bool ApiResponse_UserProfile::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<ApiResponse_UserProfile_data> refVal_setData;
...
void ApiResponse_UserProfile::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ApiResponse_UserProfile::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<ApiResponse_UserProfile_data> ApiResponse_UserProfile::getData() const
{
    return m_Data;
}


void ApiResponse_UserProfile::setData(const std::shared_ptr<ApiResponse_UserProfile_data>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool ApiResponse_UserProfile::dataIsSet() const
{
    return m_DataIsSet;
}

void ApiResponse_UserProfile::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t ApiResponse_UserProfile::getError() const
{
    return m_Error.get();
}


void ApiResponse_UserProfile::setError(const utility::string_t& value)
{
    m_Error = value;
}

bool ApiResponse_UserProfile::errorIsSet() const
{
    return m_Error.has_value();
}

void ApiResponse_UserProfile::unsetError()
{
    m_Error.reset();
}
utility::string_t ApiResponse_UserProfile::getMessage() const
{
    return m_Message.get();
}


void ApiResponse_UserProfile::setMessage(const utility::string_t& value)
{
    m_Message = value;
}

bool ApiResponse_UserProfile::messageIsSet() const
{
    return m_Message.has_value();
}

void ApiResponse_UserProfile::unsetMessage()
{
    m_Message.reset();
}
bool ApiResponse_UserProfile::isSuccess() const
{
    return m_Success;
}

void ApiResponse_UserProfile::setSuccess(bool value)
{
    m_Success = value;
    m_SuccessIsSet = true;
}

bool ApiResponse_UserProfile::successIsSet() const
{
    return m_SuccessIsSet;
}

void ApiResponse_UserProfile::unsetSuccess()
{
    m_SuccessIsSet = false;
}
