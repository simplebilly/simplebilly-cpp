...
ApiResponse_Vec_Plan::ApiResponse_Vec_Plan()
{
    m_DataIsSet = false;
    m_Success = false;
...
void ApiResponse_Vec_Plan::validate()
{
    // TODO: implement validation
}

web::json::value ApiResponse_Vec_Plan::toJson() const
{
...
bool ApiResponse_Vec_Plan::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<ApiResponse_Vec_Plan_data_inner>> refVal_setData;
...
void ApiResponse_Vec_Plan::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ApiResponse_Vec_Plan::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<ApiResponse_Vec_Plan_data_inner>> ApiResponse_Vec_Plan::getData() const
{
    return m_Data;
}


void ApiResponse_Vec_Plan::setData(const std::vector<std::shared_ptr<ApiResponse_Vec_Plan_data_inner>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool ApiResponse_Vec_Plan::dataIsSet() const
{
    return m_DataIsSet;
}

void ApiResponse_Vec_Plan::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t ApiResponse_Vec_Plan::getError() const
{
    return m_Error.get();
}


void ApiResponse_Vec_Plan::setError(const utility::string_t& value)
{
    m_Error = value;
}

bool ApiResponse_Vec_Plan::errorIsSet() const
{
    return m_Error.has_value();
}

void ApiResponse_Vec_Plan::unsetError()
{
    m_Error.reset();
}
utility::string_t ApiResponse_Vec_Plan::getMessage() const
{
    return m_Message.get();
}


void ApiResponse_Vec_Plan::setMessage(const utility::string_t& value)
{
    m_Message = value;
}

bool ApiResponse_Vec_Plan::messageIsSet() const
{
    return m_Message.has_value();
}

void ApiResponse_Vec_Plan::unsetMessage()
{
    m_Message.reset();
}
bool ApiResponse_Vec_Plan::isSuccess() const
{
    return m_Success;
}

void ApiResponse_Vec_Plan::setSuccess(bool value)
{
    m_Success = value;
    m_SuccessIsSet = true;
}

bool ApiResponse_Vec_Plan::successIsSet() const
{
    return m_SuccessIsSet;
}

void ApiResponse_Vec_Plan::unsetSuccess()
{
    m_SuccessIsSet = false;
}
