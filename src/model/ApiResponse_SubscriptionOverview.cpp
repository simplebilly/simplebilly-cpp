...
ApiResponse_SubscriptionOverview::ApiResponse_SubscriptionOverview()
{
    m_DataIsSet = false;
    m_Success = false;
...
void ApiResponse_SubscriptionOverview::validate()
{
    // TODO: implement validation
}

web::json::value ApiResponse_SubscriptionOverview::toJson() const
{
...
bool ApiResponse_SubscriptionOverview::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<ApiResponse_SubscriptionOverview_data> refVal_setData;
...
void ApiResponse_SubscriptionOverview::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ApiResponse_SubscriptionOverview::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<ApiResponse_SubscriptionOverview_data> ApiResponse_SubscriptionOverview::getData() const
{
    return m_Data;
}


void ApiResponse_SubscriptionOverview::setData(const std::shared_ptr<ApiResponse_SubscriptionOverview_data>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool ApiResponse_SubscriptionOverview::dataIsSet() const
{
    return m_DataIsSet;
}

void ApiResponse_SubscriptionOverview::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t ApiResponse_SubscriptionOverview::getError() const
{
    return m_Error.get();
}


void ApiResponse_SubscriptionOverview::setError(const utility::string_t& value)
{
    m_Error = value;
}

bool ApiResponse_SubscriptionOverview::errorIsSet() const
{
    return m_Error.has_value();
}

void ApiResponse_SubscriptionOverview::unsetError()
{
    m_Error.reset();
}
utility::string_t ApiResponse_SubscriptionOverview::getMessage() const
{
    return m_Message.get();
}


void ApiResponse_SubscriptionOverview::setMessage(const utility::string_t& value)
{
    m_Message = value;
}

bool ApiResponse_SubscriptionOverview::messageIsSet() const
{
    return m_Message.has_value();
}

void ApiResponse_SubscriptionOverview::unsetMessage()
{
    m_Message.reset();
}
bool ApiResponse_SubscriptionOverview::isSuccess() const
{
    return m_Success;
}

void ApiResponse_SubscriptionOverview::setSuccess(bool value)
{
    m_Success = value;
    m_SuccessIsSet = true;
}

bool ApiResponse_SubscriptionOverview::successIsSet() const
{
    return m_SuccessIsSet;
}

void ApiResponse_SubscriptionOverview::unsetSuccess()
{
    m_SuccessIsSet = false;
}
