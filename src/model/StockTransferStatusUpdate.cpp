...
void StockTransferStatusUpdate::validate()
{
    // TODO: implement validation
}

web::json::value StockTransferStatusUpdate::toJson() const
{
...
bool StockTransferStatusUpdate::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void StockTransferStatusUpdate::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool StockTransferStatusUpdate::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t StockTransferStatusUpdate::getStatus() const
{
    return m_Status;
}


void StockTransferStatusUpdate::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool StockTransferStatusUpdate::statusIsSet() const
{
    return m_StatusIsSet;
}

void StockTransferStatusUpdate::unsetStatus()
{
    m_StatusIsSet = false;
}
