...
ApiResponse_GdprExport::ApiResponse_GdprExport()
{
    m_DataIsSet = false;
    m_Success = false;
...
void ApiResponse_GdprExport::validate()
{
    // TODO: implement validation
}

web::json::value ApiResponse_GdprExport::toJson() const
{
...
bool ApiResponse_GdprExport::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<ApiResponse_GdprExport_data> refVal_setData;
...
void ApiResponse_GdprExport::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ApiResponse_GdprExport::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<ApiResponse_GdprExport_data> ApiResponse_GdprExport::getData() const
{
    return m_Data;
}


void ApiResponse_GdprExport::setData(const std::shared_ptr<ApiResponse_GdprExport_data>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool ApiResponse_GdprExport::dataIsSet() const
{
    return m_DataIsSet;
}

void ApiResponse_GdprExport::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t ApiResponse_GdprExport::getError() const
{
    return m_Error.get();
}


void ApiResponse_GdprExport::setError(const utility::string_t& value)
{
    m_Error = value;
}

bool ApiResponse_GdprExport::errorIsSet() const
{
    return m_Error.has_value();
}

void ApiResponse_GdprExport::unsetError()
{
    m_Error.reset();
}
utility::string_t ApiResponse_GdprExport::getMessage() const
{
    return m_Message.get();
}


void ApiResponse_GdprExport::setMessage(const utility::string_t& value)
{
    m_Message = value;
}

bool ApiResponse_GdprExport::messageIsSet() const
{
    return m_Message.has_value();
}

void ApiResponse_GdprExport::unsetMessage()
{
    m_Message.reset();
}
bool ApiResponse_GdprExport::isSuccess() const
{
    return m_Success;
}

void ApiResponse_GdprExport::setSuccess(bool value)
{
    m_Success = value;
    m_SuccessIsSet = true;
}

bool ApiResponse_GdprExport::successIsSet() const
{
    return m_SuccessIsSet;
}

void ApiResponse_GdprExport::unsetSuccess()
{
    m_SuccessIsSet = false;
}
