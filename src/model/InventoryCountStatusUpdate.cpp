...
void InventoryCountStatusUpdate::validate()
{
    // TODO: implement validation
}

web::json::value InventoryCountStatusUpdate::toJson() const
{
...
bool InventoryCountStatusUpdate::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void InventoryCountStatusUpdate::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool InventoryCountStatusUpdate::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t InventoryCountStatusUpdate::getStatus() const
{
    return m_Status;
}


void InventoryCountStatusUpdate::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool InventoryCountStatusUpdate::statusIsSet() const
{
    return m_StatusIsSet;
}

void InventoryCountStatusUpdate::unsetStatus()
{
    m_StatusIsSet = false;
}
