...
void SupplierInvoiceStatusUpdate::validate()
{
    // TODO: implement validation
}

web::json::value SupplierInvoiceStatusUpdate::toJson() const
{
...
bool SupplierInvoiceStatusUpdate::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SupplierInvoiceStatusUpdate::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SupplierInvoiceStatusUpdate::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SupplierInvoiceStatusUpdate::getStatus() const
{
    return m_Status;
}


void SupplierInvoiceStatusUpdate::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool SupplierInvoiceStatusUpdate::statusIsSet() const
{
    return m_StatusIsSet;
}

void SupplierInvoiceStatusUpdate::unsetStatus()
{
    m_StatusIsSet = false;
}
