...
void TotpEnableRequest::validate()
{
    // TODO: implement validation
}

web::json::value TotpEnableRequest::toJson() const
{
...
bool TotpEnableRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void TotpEnableRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TotpEnableRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t TotpEnableRequest::getCode() const
{
    return m_Code;
}


void TotpEnableRequest::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool TotpEnableRequest::codeIsSet() const
{
    return m_CodeIsSet;
}

void TotpEnableRequest::unsetCode()
{
    m_CodeIsSet = false;
}
