...
void MagicLinkRequest::validate()
{
    // TODO: implement validation
}

web::json::value MagicLinkRequest::toJson() const
{
...
bool MagicLinkRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MagicLinkRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MagicLinkRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t MagicLinkRequest::getEmail() const
{
    return m_Email;
}


void MagicLinkRequest::setEmail(const utility::string_t& value)
{
    m_Email = value;
    m_EmailIsSet = true;
}

bool MagicLinkRequest::emailIsSet() const
{
    return m_EmailIsSet;
}

void MagicLinkRequest::unsetEmail()
{
    m_EmailIsSet = false;
}
