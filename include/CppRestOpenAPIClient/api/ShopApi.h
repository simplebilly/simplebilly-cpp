...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_ShopApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_ShopApi_H_
...
public:
    ...
    explicit ShopApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<std::shared_ptr<AnyType>> shopEditorSave(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_ShopApi_H_ */
