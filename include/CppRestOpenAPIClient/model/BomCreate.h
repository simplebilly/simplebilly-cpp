...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_BomCreate_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_BomCreate_H_
...
protected:
    ...
    int64_t m_OutputQuantity;
    bool m_OutputQuantityIsSet;

    utility::string_t m_ProductId;
    bool m_ProductIdIsSet;

    std::shared_ptr<BomStatus> m_Status;
    bool m_StatusIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_BomCreate_H_ */
