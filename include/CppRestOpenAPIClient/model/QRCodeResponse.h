...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_QRCodeResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_QRCodeResponse_H_
...
public:
    ...
    utility::string_t getQrCodeBase64() const;
    bool qrCodeBase64IsSet() const;
    void unsetQr_code_base64();
    void setQrCodeBase64(const utility::string_t& value);
...
protected:
    ...
    utility::string_t m_Qr_code_base64;
    bool m_Qr_code_base64IsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_QRCodeResponse_H_ */
