...
/*
 * ImportStartRequest.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ImportStartRequest_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ImportStartRequest_H_
...
public:
    ...
    std::vector<int32_t> getYears() const;
    bool yearsIsSet() const;
    void unsetYears();
    void setYears(std::vector<int32_t> value);
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ImportStartRequest_H_ */
