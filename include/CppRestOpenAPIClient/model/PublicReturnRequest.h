...
/*
 * PublicReturnRequest.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_PublicReturnRequest_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_PublicReturnRequest_H_
...
public:
    ...
    std::vector<std::shared_ptr<PublicReturnItem>> getItems() const;
    bool itemsIsSet() const;
    void unsetItems();
    void setItems(const std::vector<std::shared_ptr<PublicReturnItem>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<PublicReturnItem>> m_Items;
    bool m_ItemsIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_PublicReturnRequest_H_ */
