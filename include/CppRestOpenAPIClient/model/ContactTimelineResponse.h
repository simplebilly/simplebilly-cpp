...
/*
 * ContactTimelineResponse.h
 *
 * Aggregated per-contact timeline.
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ContactTimelineResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ContactTimelineResponse_H_
...
public:
    ...
    virtual ~ContactTimelineResponse();
    ...
    /////////////////////////////////////////////
    /// ContactTimelineResponse members
    ...
    std::vector<std::shared_ptr<TimelineEvent>> getEvents() const;
    bool eventsIsSet() const;
    void unsetEvents();
    void setEvents(const std::vector<std::shared_ptr<TimelineEvent>>& value);
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ContactTimelineResponse_H_ */
