...
public:
    ...
    protected:
        eSeverity m_value;
        std::map<eSeverity,utility::string_t> enumToStrMap = {
        { eSeverity::INFO, _XPLATSTR("INFO") },
        { eSeverity::WARNING, _XPLATSTR("WARNING") },
        { eSeverity::CRITICAL, _XPLATSTR("CRITICAL") }
};
        std::map<utility::string_t,eSeverity> strToEnumMap = {
        { _XPLATSTR("INFO"), eSeverity::INFO },
        { _XPLATSTR("WARNING"), eSeverity::WARNING },
        { _XPLATSTR("CRITICAL"), eSeverity::CRITICAL }
};
