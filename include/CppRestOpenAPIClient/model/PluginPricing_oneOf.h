...
/*
 * PluginPricing_oneOf.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_PluginPricing_oneOf_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_PluginPricing_oneOf_H_
...
class  PluginPricing_oneOf
    : public ModelBase
{
public:
    PluginPricing_oneOf();
    virtual ~PluginPricing_oneOf();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_PluginPricing_oneOf_H_ */
