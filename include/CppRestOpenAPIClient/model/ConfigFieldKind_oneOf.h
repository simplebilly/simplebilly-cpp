...
/*
 * ConfigFieldKind_oneOf.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ConfigFieldKind_oneOf_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ConfigFieldKind_oneOf_H_
...
class  ConfigFieldKind_oneOf
    : public ModelBase
{
public:
    ConfigFieldKind_oneOf();
    virtual ~ConfigFieldKind_oneOf();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ConfigFieldKind_oneOf_H_ */
