...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Verfahrensdokumentation_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Verfahrensdokumentation_H_
...
public:
    ...
    virtual ~Verfahrensdokumentation();
    ...
    /////////////////////////////////////////////
    /// Verfahrensdokumentation members


    std::vector<std::shared_ptr<ComplianceEntry>> getEntries() const;
    bool entriesIsSet() const;
    void unsetEntries();
    void setEntries(const std::vector<std::shared_ptr<ComplianceEntry>>& value);
...
protected:
    std::vector<std::shared_ptr<ComplianceEntry>> m_Entries;
    bool m_EntriesIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Verfahrensdokumentation_H_ */
