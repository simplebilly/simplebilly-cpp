...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ProductStock_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ProductStock_H_
...
protected:
    ...
    boost::optional<int64_t> m_Stock_quantity;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ProductStock_H_ */
