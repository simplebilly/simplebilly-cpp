...
/*
 * GatewayOAuthAuthorizeRequest.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GatewayOAuthAuthorizeRequest_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GatewayOAuthAuthorizeRequest_H_
...
public:
    ...
    virtual ~GatewayOAuthAuthorizeRequest();
    ...
    /////////////////////////////////////////////
    /// GatewayOAuthAuthorizeRequest members


    utility::string_t getGatewayType() const;
    bool gatewayTypeIsSet() const;
    void unsetGateway_type();
    void setGatewayType(const utility::string_t& value);
...
protected:
    utility::string_t m_Gateway_type;
    bool m_Gateway_typeIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GatewayOAuthAuthorizeRequest_H_ */
