...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_AuthResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_AuthResponse_H_
...
public:
    ...
    std::shared_ptr<Model> getUser() const;
    bool userIsSet() const;
    void unsetUser();
    void setUser(const std::shared_ptr<Model>& value);


protected:
    boost::optional<utility::string_t> m_Access_token;

    boost::optional<utility::string_t> m_Message;

    boost::optional<utility::string_t> m_Refresh_token;

    bool m_Success;
    bool m_SuccessIsSet;

    boost::optional<std::shared_ptr<Model>> m_User;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_AuthResponse_H_ */
